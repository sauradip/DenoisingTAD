...
def get_args_parser():
    ...
    parser.add_argument('--feature_path',
                        default='/media/phd/SAURADIP5TB/DiffTAD/features/I3D_features',
                        type=str)
    parser.add_argument('--tem_path', default='/media/phd/SAURADIP5TB/DiffTAD/THUMOS14/TEM_scores', type=str)
    ...
    parser.add_argument('--output_dir',
                        default='/media/phd/SAURADIP5TB/DiffTAD/output/',
